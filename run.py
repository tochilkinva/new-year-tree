...
# ограничение fps необходимо для того,
# чтобы сделать анимацию картинок более простой
...
# для этого возьмем текущее окно, которое получили в hwnd
...
while running:
    ...
    for event in pygame.event.get():
        ...
        # если нажали ЛКМ на картинке, то считаем, что
        # начали перетягивать картинку
        ...
        # колесико в обратную сторону
            ...
            gif_anim.change_gif(-1)
        # если мышка зажата, то смотрим разницу между
        # предыдущей позицией мышки и текущей
        if mouse_pressed:
            current_pos = pygame.mouse.get_pos()
            delta_x = start_mouse_pos[0] - current_pos[0]
            delta_y = start_mouse_pos[1] - current_pos[1]
